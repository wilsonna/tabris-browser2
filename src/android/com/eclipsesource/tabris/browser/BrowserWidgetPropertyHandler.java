...
public class BrowserWidgetPropertyHandler extends TabrisWidgetPropertyHandler<CalendarView> {

  public BrowserWidgetPropertyHandler( Activity activity, TabrisContext tabrisContext ) {
