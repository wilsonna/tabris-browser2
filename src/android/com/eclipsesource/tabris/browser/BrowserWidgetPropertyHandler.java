...
public class BrowserWidgetPropertyHandler extends BrowserPropertyHandler<Browser> {
	// private final IAbsoluteUriBuilder absoluteUriBuilder;
	private final CookieManager cookieManager;

	public BrowserWidgetPropertyHandler(TabrisActivity activity, IAbsoluteUriBuilder absoluteUriBuilder, CookieManager cookieManager) {
	...
	// }
	/*
	 * @Override public void set(Browser browser, Properties properties) {
	 * super.set(browser, properties); setInitScript(browser, properties);
	 * setHeaders(browser, properties); setUrl(browser, properties);
	 * setHtml(browser, properties); }
	 * 
	 * private void setUrl(Browser browser, Properties properties) { String url
	 * = properties.getString("url"); if (url != null) { if
	 * (Uri.parse(url).isAbsolute()) { browser.loadUrl(url); } else {
	 * browser.loadUrl(absoluteUriBuilder.build(url).toString()); } } }
	 * 
	 * private void setInitScript(Browser browser, Properties properties) {
	 * String initScript = properties.getString("initScript"); if (initScript !=
	 * null) { browser.setInitScript(initScript); } }
	 * 
	 * private void setHeaders(Browser browser, Properties properties) {
	 * Properties headers = properties.getProperties("headers"); if (headers !=
	 * null) { browser.setHeaders(headers.getAll()); } }
	 * 
	 * private void setHtml(Browser browser, Properties properties) { String
	 * html = properties.getString("html"); if (html != null) {
	...
	public Object get(Browser browser, String property) {
		...
		/*
		 * if (property.equals("url")) { return getUrl(browser); } if
		 * (property.equals("html")) { return getHtml(browser); } else { return
		 * super.get(browser, property); }
		 */
		return super.get(browser, property);
	}

	/*
	 * private Object getHtml(Browser browser) { return browser.getHtml(); }
	 * 
	 * private String getUrl(Browser browser) { if (browser.getHtml() != null) {
	 * return ""; } if (browser.getUrl() != null) { return browser.getUrl(); }
	 * if (browser.getOriginalUrl() != null) { return browser.getOriginalUrl();
	 * } else { return ""; } }
	 */
